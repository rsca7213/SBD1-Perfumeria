        ...
        <div class="container-fluid" id="app"> 
            ...
            <div class="row mt-1"> 
                <div class="col-4 justify-content-center text-center mt-4 pt-2">
                    <a href="{{ route('menuProveedor', ['id_prov' => 1]) }}"><img src=" {{ asset('img/empresas/emerald.png') }}" width="350" alt="Emerald Performance Materials" ></a>
                </div>
                <div class="col-4 justify-content-center text-center">
                    <a href="{{ route('menuProveedor', ['id_prov' => 2]) }}"><img src=" {{ asset('img/empresas/firmenich.png') }}" width="275" alt="Firmenich"></a>
                </div>
                <div class="col-4 justify-content-center text-center pt-4">
                    <a href="{{ route('menuProveedor', ['id_prov' => 3]) }}"><img src=" {{ asset('img/empresas/indesso.png') }}" width="275" alt="Indesso"></a>
                </div>
            </div>
            <div class="row mt-1"> 
                <div class="col-4 justify-content-center text-center">
