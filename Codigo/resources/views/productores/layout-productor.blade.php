...
<html lang="es">
    <head>
        <head>
            ...
            <link rel="stylesheet" href=" {{ asset('css/productores/layout-productor.css') }}">
        ...
        <div id="app">
            <nav class="navbar navbar-expand-lg navbar-light shadow" style="background-color: #F5F5F5">
                <a href="{{ url('/') }}" class="navbar-brand mx-4 pr-4">
                    @if ($id_prod == 1)
                        <img src="{{ asset('img/empresas/givaudan.png') }}" alt="Givaudan" width="150">
                    @endif
                    @if ($id_prod == 2)
                        <img src="{{ asset('img/empresas/memphis.png') }}" alt="Memphis" width="80">
                    @endif
                    @if ($id_prod == 3)
                        <img src="{{ asset('img/empresas/chanel.png') }}" alt="Chanel" width="100">
                    @endif
                </a>
