<template>
    <span>
        ...
        <span v-if="tipoEv === 'anual'"> 
            ...
            <div class="row mx-4 p-2 border border-info" v-for="(prov,index) in provsAnual" :key="index">
                ...
                <span class="col-12"> &#x2022; <b> Fecha de renovación más reciente: </b> 
                    ...
                    <span v-else> {{ prov["fechaR"] }} ( renovado {{ prov["renov"]}} 
                        <span v-if="prov['renov'] == 1"> vez </span> <span v-else> veces </span>
                    )</span>
                </span>
                <div class="col-12 row d-flex justify-content-center mt-2">
        ...
        <span v-if="tipoEv === 'anualStart'"> 
            <form action="anual" method="POST" @submit.prevent="enviarAnual(provAnualData['idp'],provAnualData['fecha_ap_ts'])">
                <div class="row d-flex justify-content-center">
                ...
                <div class="flex-row d-flex justify-content-center mx-4 align-items-center">
                    ...
                    id="anualCump" v-model.number="provAnualRes[0]" :class="anualCumpErr">
                    <span class="ml-2" style="font-size: 16px"> 
                        <b> (de {{escala.ri}} a {{escala.rf}}) </b> 
                    </span>
                </div>
        ...
        <span v-if="tipoEv === 'resultadoAnual'">
            ...
            <div class="row h5 text-left ml-4 pl-4" v-else> 
                <li> <b class="mr-1"> Fecha de Renovación Actual: </b> N/A </li>
            </div>
            <div class="row h5 text-left ml-4 pl-4"> 
...
export default {
    ...
    data() {
        return {
            ...
            provAnualRes: [0], /*arreglo que contiene los resultados que se van asignando
    ...
    methods: {
        ...
        dataAnual(idp, fecha_ap_ts) {
            ...
            axios.get("data/anual/" + idp + "/" + fecha_ap_ts)
            .then(response => {
                console.log("%cAxios: Success!", "color: lightgreen");
